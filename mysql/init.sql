-- 로컬 테스트용 초기 데이터베이스 설정
USE conferent;

-- 기본 관리자 계정 (로컬 테스트용) - BCrypt 암호화된 비밀번호
INSERT INTO users (name, email, password, role, created_at, updated_at) VALUES
('시스템 관리자', 'admin@conferent.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'ADMIN', NOW(), NOW()),
('운영 관리자', 'operator@conferent.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'ADMIN', NOW(), NOW()),
('테스트 사용자', 'user@conferent.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'USER', NOW(), NOW());
